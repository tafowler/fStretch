...
namespace {
	const MString kAddAttrError("ERROR in addAttribute");
	const MString kAttrEffectsError("ERROR in attributeAffects");
}
...
MStatus fStretch::initialize()
{
	...
	status = addAttribute( restMesh );
	MCheckStatus(status, kAddAttrError);
	...
	mAttr.setStorable(true);
	mAttr.setChannelBox(false);
	status = addAttribute( squashMesh );	
	MCheckStatus(status, kAddAttrError);
	...
	mAttr.setStorable(true);
	mAttr.setChannelBox(false);
	status = addAttribute( stretchMesh );		MCheckStatus(status, kAddAttrError);
	...
	mAttr.setStorable(true);
	mAttr.setChannelBox(false);
	status = addAttribute( bendInMesh );		MCheckStatus(status, kAddAttrError);
	...
	mAttr.setStorable(true);
	mAttr.setChannelBox(false);
	status = addAttribute( bendOutMesh );		MCheckStatus(status, kAddAttrError);
	...
	status = addAttribute (tensionEnvelope);		MCheckStatus(status, kAddAttrError);
	...
	status = addAttribute (tensionSmooth);	MCheckStatus(status, kAddAttrError);
	...
	status = addAttribute (paintTensionSmooth);	MCheckStatus(status, kAddAttrError);
	...
	status = addAttribute( tensionSmoothAttribute );		MCheckStatus(status, kAddAttrError);

	// tensionPostSmooth
	tensionPostSmooth = numericAttr.create( "tensionPostSmooth", "tsgss",	MFnNumericData::kInt, 0, &status );
	numericAttr.setKeyable(true);
	numericAttr.setMin(0);
	status = addAttribute (tensionPostSmooth);	MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setSoftMin(0);
	numericAttr.setSoftMax(1);
	status = addAttribute (tensionUDirection);		MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setSoftMin(0);
	numericAttr.setSoftMax(1);
	status = addAttribute (tensionVDirection);		MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setUsesArrayDataBuilder(true);
	numericAttr.setHidden(true);
	status = addAttribute (paintTensionDirection);	MCheckStatus(status, kAddAttrError);
	...
	cAttr.setHidden(true); 
	status = addAttribute( tensionDirectionAttribute );		MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setUsesArrayDataBuilder(true);
	numericAttr.setHidden(true);
	status = addAttribute (paintAngleDirection);	MCheckStatus(status, kAddAttrError);

	// tensionSmoothAttribute Compound attribute
	angleDirectionAttribute = cAttr.create("angleDirectionAttribute", "ada");
	cAttr.addChild(paintAngleDirection);
	cAttr.setHidden(true); 
	status = addAttribute( angleDirectionAttribute );		MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setSoftMin(0);
	numericAttr.setSoftMax(1);
	status = addAttribute (stretchMultiplier);	MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setSoftMax(1);
	status = addAttribute (stretchRange);	MCheckStatus(status, kAddAttrError);
	...
	status = addAttribute (stretchGrowShrink);	MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setUsesArrayDataBuilder(true); 
	numericAttr.setHidden(true); 
	status = addAttribute (paintStretchGrowShrink);	MCheckStatus(status, kAddAttrError);
	...
	cAttr.setHidden(true); 
	status = addAttribute( stretchGrowShrinkAttribute );		MCheckStatus(status, kAddAttrError);
	...
	status = addAttribute (stretchRelax);	MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setSoftMin(0);
	numericAttr.setSoftMax(1);
	status = addAttribute (squashMultiplier);	MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setMin(0.001);
	numericAttr.setSoftMax(1);
	status = addAttribute (squashRange);	MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setSoftMin(-10);
	numericAttr.setSoftMax(10);
	status = addAttribute (squashGrowShrink);	MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setUsesArrayDataBuilder(true); 
	numericAttr.setHidden(true); 
	status = addAttribute (paintSquashGrowShrink);	MCheckStatus(status, kAddAttrError);
	...
	cAttr.setHidden(true); 
	status = addAttribute( squashGrowShrinkAttribute );		MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setMin(0);
	numericAttr.setSoftMax(20);
	status = addAttribute (squashRelax);	MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setUsesArrayDataBuilder(true);
	numericAttr.setHidden(true);
	status = addAttribute (paintTensionRange);	MCheckStatus(status, kAddAttrError);
	...
	cAttr.setHidden(true); 
	status = addAttribute( tensionRangeAttribute );		MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setSoftMin(0);
	numericAttr.setSoftMax(1);
	status = addAttribute (angleEnvelope);	MCheckStatus(status, kAddAttrError);
	...
	status = addAttribute (angleSmooth);	MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setUsesArrayDataBuilder(true); 
	numericAttr.setHidden(true); 
	status = addAttribute (paintAngleSmooth);	MCheckStatus(status, kAddAttrError);

	// angleSmoothAttribute Compound attribute
	angleSmoothAttribute = cAttr.create("angleSmoothAttribute", "asma");
	cAttr.addChild(paintAngleSmooth);
	cAttr.setHidden(true); 
	status = addAttribute( angleSmoothAttribute );		MCheckStatus(status, kAddAttrError);

	// anglePostSmooth
	anglePostSmooth = numericAttr.create( "anglePostSmooth", "asgss",	MFnNumericData::kInt, 0, &status );
	numericAttr.setKeyable(true);
	numericAttr.setMin(0);
	status = addAttribute (anglePostSmooth);	MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setSoftMin(0);
	numericAttr.setSoftMax(1);
	status = addAttribute (angleUDirection);	MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setSoftMin(0);
	numericAttr.setSoftMax(1);
	status = addAttribute (angleVDirection);	MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setSoftMin(0);
	numericAttr.setSoftMax(1);
	status = addAttribute (bendIn);	MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setMin(0.001);
	numericAttr.setSoftMax(1);
	status = addAttribute (bendInRange);	MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setSoftMin(-10);
	numericAttr.setSoftMax(10);
	status = addAttribute (bendInGrowShrink);	MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setUsesArrayDataBuilder(true); 
	numericAttr.setHidden(true); 
	status = addAttribute (paintBendInGrowShrink);	MCheckStatus(status, kAddAttrError);

	// angleSmoothAttribute Compound attribute
	bendInGrowShrinkAttribute = cAttr.create("bendInGrowShrinkAttribute", "bigsa");
	cAttr.addChild(paintBendInGrowShrink);
	cAttr.setHidden(true); 
	status = addAttribute( bendInGrowShrinkAttribute );		MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setMin(0);
	numericAttr.setSoftMax(20);
	status = addAttribute (bendInRelax);	MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setSoftMin(0);
	numericAttr.setSoftMax(1);
	status = addAttribute (bendOut);	MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setMin(0.001);
	numericAttr.setSoftMax(1);
	status = addAttribute (bendOutRange);	MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setSoftMin(-10);
	numericAttr.setSoftMax(10);
	status = addAttribute (bendOutGrowShrink);	MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setUsesArrayDataBuilder(true); 
	numericAttr.setHidden(true); 
	status = addAttribute (paintBendOutGrowShrink);	MCheckStatus(status, kAddAttrError);

	// angleSmoothAttribute Compound attribute
	bendOutGrowShrinkAttribute = cAttr.create("bendOutGrowShrinkAttribute", "bogsa");
	cAttr.addChild(paintBendOutGrowShrink);
	cAttr.setHidden(true); 
	status = addAttribute( bendOutGrowShrinkAttribute );		MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setMin(0);
	numericAttr.setSoftMax(20);
	status = addAttribute (bendOutRelax);	MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setUsesArrayDataBuilder(true);
	numericAttr.setHidden(true);
	status = addAttribute (paintAngleRange);	MCheckStatus(status, kAddAttrError);

	// angleRange Compound attribute
	angleRangeAttribute = cAttr.create("angleRangeAttribute", "aranga");
	cAttr.addChild(paintAngleRange);
	cAttr.setHidden(true); 
	status = addAttribute( angleRangeAttribute );		MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setKeyable(true);
	status = addAttribute (wrap);	MCheckStatus(status, kAddAttrError);
	...
	status = addAttribute (wrapSmoothRadius);	MCheckStatus(status, kAddAttrError);
	...
	status = addAttribute (wrapOneTriPerFace);	MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setMax(1);
	numericAttr.setHidden(true);
	status = addAttribute (wrapItemsPerRadius);	MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setMax(1);
	numericAttr.setHidden(true);
	status = addAttribute (wrapCentralFactor);	MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setKeyable(true);
	status = addAttribute (drawColorPerVertex);	MCheckStatus(status, kAddAttrError);
	...
	status = addAttribute(colorDisplay); MCheckStatus(status, kAddAttrError);
	...
	status = addAttribute (tensionColorContrast);	MCheckStatus(status, kAddAttrError);
	...
	status = addAttribute (angleColorContrast);	MCheckStatus(status, kAddAttrError);

	// forceColorRefresh
	forceColorRefresh = numericAttr.create( "forceColorRefresh", "fcr",	MFnNumericData::kBoolean, 1, &status );
	numericAttr.setKeyable(true);
	status = addAttribute (forceColorRefresh);	MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setUsesArrayDataBuilder(true);
	numericAttr.setHidden(true);
	status = addAttribute (paintStretchRelax);	MCheckStatus(status, kAddAttrError);
	...
	cAttr.setHidden(true); 
	status = addAttribute( stretchRelaxAttribute );		MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setUsesArrayDataBuilder(true);
	numericAttr.setHidden(true);
	status = addAttribute (paintSquashRelax);	MCheckStatus(status, kAddAttrError);
	...
	cAttr.setHidden(true); 
	status = addAttribute( squashRelaxAttribute );		MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setUsesArrayDataBuilder(true);
	numericAttr.setHidden(true);
	status = addAttribute (paintBendInRelax);	MCheckStatus(status, kAddAttrError);
	...
	cAttr.setHidden(true); 
	status = addAttribute( bendInRelaxAttribute );		MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setUsesArrayDataBuilder(true);
	numericAttr.setHidden(true);
	status = addAttribute (paintBendOutRelax);	MCheckStatus(status, kAddAttrError);
	...
	cAttr.setHidden(true); 
	status = addAttribute( bendOutRelaxAttribute );		MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setKeyable(true);
	status = addAttribute (UseAllAvailableProcessors);	MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setKeyable(true);
	numericAttr.setMin(1);
	status = addAttribute (NumberOfProcessorsToUse);	MCheckStatus(status, kAddAttrError);

	// displayWarnings Attribute
	displayWarnings = numericAttr.create( "displayWarnings", "diswar", MFnNumericData::kBoolean, 1, &status );
	numericAttr.setKeyable(true);
	status = addAttribute (displayWarnings);	MCheckStatus(status, kAddAttrError);
	...
	numericAttr.setKeyable(true);
	numericAttr.setHidden(true);
	status = addAttribute (displayComputeTime);	MCheckStatus(status, kAddAttrError);

	// scaleFactor
	scaleFactor = numericAttr.create( "scaleFactor", "sclf",	MFnNumericData::kFloat, 1.0, &status );
	numericAttr.setKeyable(true);
	status = addAttribute (scaleFactor);	MCheckStatus(status, kAddAttrError);
	...
	// Attributes Affects
	status = attributeAffects( restMesh, outputGeom );				MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( squashMesh, outputGeom );			MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( stretchMesh, outputGeom );			MCheckStatus(status, kAttrEffectsError);

	status = attributeAffects( tensionEnvelope, outputGeom );		MCheckStatus(status, kAttrEffectsError);

	status = attributeAffects( squashMultiplier, outputGeom );		MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( stretchMultiplier, outputGeom );		MCheckStatus(status, kAttrEffectsError);

	status = attributeAffects( tensionSmooth, outputGeom );			MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( drawColorPerVertex, outputGeom );	MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( colorDisplay, outputGeom );			MCheckStatus(status, kAttrEffectsError);

	status = attributeAffects( paintTensionSmooth, outputGeom );	MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( paintAngleSmooth, outputGeom );		MCheckStatus(status, kAttrEffectsError);

	status = attributeAffects( paintTensionDirection, outputGeom );	MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( paintAngleDirection, outputGeom );	MCheckStatus(status, kAttrEffectsError);

	status = attributeAffects( squashRange, outputGeom );			MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( stretchRange, outputGeom );			MCheckStatus(status, kAttrEffectsError);

	status = attributeAffects( tensionColorContrast, outputGeom );	MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( angleColorContrast, outputGeom );	MCheckStatus(status, kAttrEffectsError);

	status = attributeAffects( wrap, outputGeom );					MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( wrapSmoothRadius, outputGeom );		MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( wrapItemsPerRadius, outputGeom );	MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( wrapCentralFactor, outputGeom );		MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( wrapOneTriPerFace, outputGeom );		MCheckStatus(status, kAttrEffectsError);

	status = attributeAffects( stretchFalloff, outputGeom );		MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( squashFalloff, outputGeom );			MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( bendInFalloff, outputGeom );			MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( bendOutFalloff, outputGeom );		MCheckStatus(status, kAttrEffectsError);

	status = attributeAffects( tensionUDirection, outputGeom );		MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( tensionVDirection, outputGeom );		MCheckStatus(status, kAttrEffectsError);

	status = attributeAffects( angleEnvelope, outputGeom );			MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( angleSmooth, outputGeom );			MCheckStatus(status, kAttrEffectsError);

	status = attributeAffects( bendIn, outputGeom );				MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( bendOut, outputGeom );				MCheckStatus(status, kAttrEffectsError);

	status = attributeAffects( bendInRange, outputGeom );			MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( bendOutRange, outputGeom );			MCheckStatus(status, kAttrEffectsError);

	status = attributeAffects( angleUDirection, outputGeom );		MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( angleVDirection, outputGeom );		MCheckStatus(status, kAttrEffectsError);

	status = attributeAffects( bendInMesh, outputGeom );			MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( bendOutMesh, outputGeom );			MCheckStatus(status, kAttrEffectsError);

	status = attributeAffects( tensionColorRamp, outputGeom );		MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( angleColorRamp, outputGeom );		MCheckStatus(status, kAttrEffectsError);

	status = attributeAffects( UsquashMesh, outputGeom );			MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( VsquashMesh, outputGeom );			MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( UstretchMesh, outputGeom );			MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( VstretchMesh, outputGeom );			MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( UbendInMesh, outputGeom );			MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( VbendInMesh, outputGeom );			MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( UbendOutMesh, outputGeom );			MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( VbendOutMesh, outputGeom );			MCheckStatus(status, kAttrEffectsError);

	status = attributeAffects( UseAllAvailableProcessors, outputGeom );	MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( NumberOfProcessorsToUse, outputGeom );	MCheckStatus(status, kAttrEffectsError);

	status = attributeAffects( scaleFactor, outputGeom );			MCheckStatus(status, kAttrEffectsError);

	status = attributeAffects( stretchGrowShrink, outputGeom );		MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( squashGrowShrink, outputGeom );		MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( tensionPostSmooth, outputGeom );		MCheckStatus(status, kAttrEffectsError);

	status = attributeAffects( bendInGrowShrink, outputGeom );		MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( bendOutGrowShrink, outputGeom );		MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( anglePostSmooth, outputGeom );		MCheckStatus(status, kAttrEffectsError);

	status = attributeAffects( paintStretchGrowShrink, outputGeom );MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( paintSquashGrowShrink, outputGeom );	MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( paintBendInGrowShrink, outputGeom );	MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( paintBendOutGrowShrink, outputGeom );MCheckStatus(status, kAttrEffectsError);

	status = attributeAffects( stretchRelax, outputGeom );			MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( squashRelax, outputGeom );			MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( bendInRelax, outputGeom );			MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( bendOutRelax, outputGeom );			MCheckStatus(status, kAttrEffectsError);

	status = attributeAffects( paintTensionRange, outputGeom );		MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( paintAngleRange, outputGeom );		MCheckStatus(status, kAttrEffectsError);

	status = attributeAffects( paintStretchRelax, outputGeom );		MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( paintSquashRelax, outputGeom );		MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( paintBendInRelax, outputGeom );		MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( paintBendOutRelax, outputGeom );		MCheckStatus(status, kAttrEffectsError);

	status = attributeAffects( counterSharpAreas, outputGeom );	MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( tensionFalloff, outputGeom );	MCheckStatus(status, kAttrEffectsError);
	status = attributeAffects( angleFalloff, outputGeom );	MCheckStatus(status, kAttrEffectsError);
